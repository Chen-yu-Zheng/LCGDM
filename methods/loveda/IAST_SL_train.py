...
def main():
    ...
    logger = get_console_file_logger(name='IAST', logdir=cfg.SNAPSHOT_DIR)
    ...
    for i_iter in tqdm(range(cfg.NUM_STEPS_STOP)):
        if i_iter < cfg.WARMUP_STEP:
            ...
            loss_dict['penalty_loss'] = penalty_loss * cfg.PENALTY_LOSS_WEIGHT 
            loss_dict['local_loss'] = loss_local
            loss_dict['global_loss'] = loss_global 

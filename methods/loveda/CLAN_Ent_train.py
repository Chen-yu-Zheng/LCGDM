...
# =============================================================================
    ...
    for i_iter in tqdm(range(cfg.NUM_STEPS_STOP)):
        ...
        ## Our Loss
        entloss = entropy_loss(pred_target1 + pred_target2) * cfg.PENALTY_LOSS_WEIGHT
        (loss_adv + entloss).backward()
        ...
        if i_iter % 50 == 0:
            ...
            text = 'iter = %d, loss_seg = %.4f loss_adv = %.4f, loss_weight = %.4f, loss_D_s = %.4f loss_D_t = %.4f loss_ent = %.4f G_lr = %.5f D_lr = %.5f' % \
                (i_iter, loss_seg, loss_adv, loss_weight, loss_D_s, loss_D_t, entloss, lr, lr_D)
            logger.info(text)
